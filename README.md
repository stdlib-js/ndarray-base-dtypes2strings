...
```javascript
import dtypes2strings from 'https://cdn.jsdelivr.net/gh/stdlib-js/ndarray-base-dtypes2strings@v0.1.0-deno/mod.js';
```
...
[test-image]: https://github.com/stdlib-js/ndarray-base-dtypes2strings/actions/workflows/test.yml/badge.svg?branch=v0.1.0
[test-url]: https://github.com/stdlib-js/ndarray-base-dtypes2strings/actions/workflows/test.yml?query=branch:v0.1.0
